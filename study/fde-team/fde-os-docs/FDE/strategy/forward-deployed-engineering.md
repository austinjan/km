...
- `docs/FDE/engagement/fde-engagement-playbook.md`
- `docs/FDE/strategy/ceo-business-model-and-nimbl-future.md`

未來可以在 repo 補以下模板：

- `docs/FDE/engagement/templates/fde-customer-readiness-scorecard.md`
- `docs/FDE/engagement/templates/fde-workflow-discovery-brief.md`
- `docs/FDE/engagement/templates/fde-agent-spec.md`
- `docs/FDE/engagement/templates/fde-production-readiness-checklist.md`
- `docs/FDE/engagement/templates/fde-pilot-retrospective.md`
- `docs/FDE/engagement/templates/fde-commercial-proposal.md`
- `docs/FDE/engagement/templates/fde-acceptance-criteria.md`
- `docs/FDE/engagement/templates/fde-know-how-capture-map.md`
- `docs/FDE/engagement/templates/fde-agent-skill-asset.md`
- `docs/FDE/engagement/templates/fde-product-gap-report.md`
- `docs/FDE/engagement/templates/fde-build-prove-generalize-retrospective.md`
