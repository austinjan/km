...
tags: [windows, powershell, clipboard, keybinding, productivity]
created: 2026-03-30
summary: PowerShell keybinding (Ctrl+Y) that re-runs the last command and copies both the command and its output to the Windows clipboard via Set-Clipboard.
related:
