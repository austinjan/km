...
tags: [macos, mac-mini, remote-development, ssh, tmux, tailscale, homebrew]
created: 2026-03-30
summary: Complete guide for setting up a Mac Mini as a remote development machine using Tailscale VPN, SSH with key auth, and tmux for session persistence. Covers Homebrew, security hardening, port forwarding, and Ghostty terminfo fix.
related:
