---
title: WSL Ubuntu Setup Guide
tags: [windows, wsl, ubuntu, nodejs, rust, zed, ssh, cli-tools, development-environment]
created: 2026-03-28
summary: Step-by-step WSL2 Ubuntu development environment setup covering Node.js (nvm), Rust, GitHub CLI, Zed editor with GPU support, SSH keychain, and modern CLI utilities (zoxide, starship, bat, fd, ripgrep).
related:
